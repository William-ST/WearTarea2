...
public class Partida {
   ...
   /* public int getMisJuegos(){
    ...
    public void setMiPuntuacion(byte miPuntuacion) {
        puntos.lastElement().setMiPuntuacion(miPuntuacion);
    }

    public void setSuPuntuacion(byte suPuntuacion) {
        puntos.lastElement().setSuPuntuacion(suPuntuacion);
    }

    public void setMisJuegos(byte misJuegos) {
        puntos.lastElement().setMisJuegos(misJuegos);
    }

    public void setSusJuegos(byte susJuegos) {
        puntos.lastElement().setSusJuegos(susJuegos);
    }

    public void setMisSets(byte misSets) {
        puntos.lastElement().setMisSets(misSets);
    }
    public void setSusSets(byte susSets) {
        puntos.lastElement().setSusSets(susSets);
    }
